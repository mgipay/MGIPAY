...
public class CurrencyConversionList  implements java.io.Serializable {
    private com.mgipaypal.paypal.client.CurrencyType baseAmount;

    private com.mgipaypal.paypal.client.CurrencyType[] currencyList;

    public CurrencyConversionList() {
    }

    public CurrencyConversionList(
           com.mgipaypal.paypal.client.CurrencyType baseAmount,
           com.mgipaypal.paypal.client.CurrencyType[] currencyList) {
     ...
     * @return baseAmount
     */
    public com.mgipaypal.paypal.client.CurrencyType getBaseAmount() {
        return baseAmount;
    }
     ...
     * @param baseAmount
     */
    public void setBaseAmount(com.mgipaypal.paypal.client.CurrencyType baseAmount) {
        this.baseAmount = baseAmount;
    }
     ...
     * @return currencyList
     */
    public com.mgipaypal.paypal.client.CurrencyType[] getCurrencyList() {
        return currencyList;
    }
     ...
     * @param currencyList
     */
    public void setCurrencyList(com.mgipaypal.paypal.client.CurrencyType[] currencyList) {
        this.currencyList = currencyList;
    }
