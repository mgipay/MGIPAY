 ...
 */
public class SenderIdentifier  extends com.mgipaypal.paypal.client.AccountIdentifier  implements java.io.Serializable {
    private java.lang.Boolean useCredentials;

    private com.mgipaypal.paypal.client.TaxIdDetails taxIdDetails;
    ...
    public SenderIdentifier(
           ...
           com.mgipaypal.paypal.client.TaxIdDetails taxIdDetails) {
        super(
            email,
            phone,
            _any);
     ...
     * @return taxIdDetails
     */
    public com.mgipaypal.paypal.client.TaxIdDetails getTaxIdDetails() {
        return taxIdDetails;
    }
     ...
     * @param taxIdDetails
     */
    public void setTaxIdDetails(com.mgipaypal.paypal.client.TaxIdDetails taxIdDetails) {
        this.taxIdDetails = taxIdDetails;
    }
