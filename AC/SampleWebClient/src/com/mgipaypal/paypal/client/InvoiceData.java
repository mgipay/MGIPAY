...
public class InvoiceData  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    private com.mgipaypal.paypal.client.InvoiceItem[] item;
    ...
    public InvoiceData(
           com.mgipaypal.paypal.client.InvoiceItem[] item,
     ...
     * @return item
     */
    public com.mgipaypal.paypal.client.InvoiceItem[] getItem() {
        return item;
    }
     ...
     * @param item
     */
    public void setItem(com.mgipaypal.paypal.client.InvoiceItem[] item) {
        this.item = item;
    }

    public com.mgipaypal.paypal.client.InvoiceItem getItem(int i) {
        return this.item[i];
    }

    public void setItem(int i, com.mgipaypal.paypal.client.InvoiceItem _value) {
        this.item[i] = _value;
    }
