...
public class GetUserLimitsResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.mgipaypal.paypal.client.UserLimit[] userLimit;
    ...
    public GetUserLimitsResponse(
           ...
           com.mgipaypal.paypal.client.UserLimit[] userLimit,
     ...
     * @return userLimit
     */
    public com.mgipaypal.paypal.client.UserLimit[] getUserLimit() {
        return userLimit;
    }
     ...
     * @param userLimit
     */
    public void setUserLimit(com.mgipaypal.paypal.client.UserLimit[] userLimit) {
        this.userLimit = userLimit;
    }

    public com.mgipaypal.paypal.client.UserLimit getUserLimit(int i) {
        return this.userLimit[i];
    }

    public void setUserLimit(int i, com.mgipaypal.paypal.client.UserLimit _value) {
