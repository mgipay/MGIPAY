...
public class PayError  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.mgipaypal.paypal.client.ErrorData error;
    ...
    public PayError(
           ...
           com.mgipaypal.paypal.client.ErrorData error,
     ...
     * @return error
     */
    public com.mgipaypal.paypal.client.ErrorData getError() {
        return error;
    }
     ...
     * @param error
     */
    public void setError(com.mgipaypal.paypal.client.ErrorData error) {
        this.error = error;
    }
