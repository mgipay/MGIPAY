...
public class GetUserLimitsRequest  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.mgipaypal.paypal.client.AccountIdentifier user;
    ...
    public GetUserLimitsRequest(
           ...
           com.mgipaypal.paypal.client.AccountIdentifier user,
     ...
     */
    public com.mgipaypal.paypal.client.AccountIdentifier getUser() {
        return user;
    }
     ...
     */
    public void setUser(com.mgipaypal.paypal.client.AccountIdentifier user) {
        this.user = user;
    }
