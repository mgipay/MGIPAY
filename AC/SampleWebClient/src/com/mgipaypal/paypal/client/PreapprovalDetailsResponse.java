...
public class PreapprovalDetailsResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.mgipaypal.paypal.client.Address[] addressList;
    ...
    public PreapprovalDetailsResponse(
           ...
           com.mgipaypal.paypal.client.Address[] addressList,
     ...
     * @return addressList
     */
    public com.mgipaypal.paypal.client.Address[] getAddressList() {
        return addressList;
    }
     ...
     * @param addressList
     */
    public void setAddressList(com.mgipaypal.paypal.client.Address[] addressList) {
        this.addressList = addressList;
    }
