...
$(document).ready(function() {
	...
	if($.browser.chrome) {
		logoutClicked = localStorage.getItem("logoutClicked");
		loggedIn = localStorage.getItem("userLogin");
	} else {
		logoutClicked = $.cookie("logoutClicked");
	...
	if(loggedIn == "yes")
	{
		...
		$('.loginDisable').removeClass('paypal_login');
	}
	else
	{
		...
		$('.loginDisable').addClass('paypal_login');
	}
