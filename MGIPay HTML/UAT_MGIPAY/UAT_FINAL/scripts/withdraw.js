...
$(document).ready(function() {
	$(".mainwrapper").addClass("displayblock").removeClass("displaynone");
	$("#fee_value").val("USD");
...
function sendMail()
{
	...
	sendObj.TransactionAmount = totalAmt;
