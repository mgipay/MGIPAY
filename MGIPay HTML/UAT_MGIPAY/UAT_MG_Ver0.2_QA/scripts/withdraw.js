...
var locationFailureHandler = setTimeout(function(response){
	$("#preview").hide();
		if(flag == true)
		{
		}
...
var getLimitFailureHandler = setTimeout(function(response){
	$("#preview").hide();
		if(flag == true)
		{
		}
