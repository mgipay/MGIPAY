...
public class Address  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.axis.svcs.types.common.BaseAddress baseAddress;
    ...
    public Address(
           ...
           com.paypal.axis.svcs.types.common.BaseAddress baseAddress,
     ...
     * @return baseAddress
     */
    public com.paypal.axis.svcs.types.common.BaseAddress getBaseAddress() {
        return baseAddress;
    }
     ...
     * @param baseAddress
     */
    public void setBaseAddress(com.paypal.axis.svcs.types.common.BaseAddress baseAddress) {
        this.baseAddress = baseAddress;
    }
