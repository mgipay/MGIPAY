...
public class FundingConstraint  implements java.io.Serializable {
    private com.paypal.axis.svcs.types.ap.FundingTypeInfo[] allowedFundingType;

    public FundingConstraint() {
    }

    public FundingConstraint(
           com.paypal.axis.svcs.types.ap.FundingTypeInfo[] allowedFundingType) {
     ...
     */
    public com.paypal.axis.svcs.types.ap.FundingTypeInfo[] getAllowedFundingType() {
        return allowedFundingType;
    }
     ...
     */
    public void setAllowedFundingType(com.paypal.axis.svcs.types.ap.FundingTypeInfo[] allowedFundingType) {
        this.allowedFundingType = allowedFundingType;
    }
