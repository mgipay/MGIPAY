 ...
 */
public class SenderIdentifier  extends com.paypal.axis.svcs.types.common.AccountIdentifier  implements java.io.Serializable {
    private java.lang.Boolean useCredentials;

    private com.paypal.axis.svcs.types.ap.TaxIdDetails taxIdDetails;
    ...
    public SenderIdentifier(
           ...
           com.paypal.axis.svcs.types.ap.TaxIdDetails taxIdDetails) {
        super(
            email,
            phone,
            _any);
     ...
     * @return taxIdDetails
     */
    public com.paypal.axis.svcs.types.ap.TaxIdDetails getTaxIdDetails() {
        return taxIdDetails;
    }
     ...
     * @param taxIdDetails
     */
    public void setTaxIdDetails(com.paypal.axis.svcs.types.ap.TaxIdDetails taxIdDetails) {
        this.taxIdDetails = taxIdDetails;
    }
