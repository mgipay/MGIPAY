...
public class RefundInfo  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.axis.svcs.types.common.ErrorData[] errorList;
    ...
    public RefundInfo(
           ...
           com.paypal.axis.svcs.types.common.ErrorData[] errorList,
     ...
     * @return errorList
     */
    public com.paypal.axis.svcs.types.common.ErrorData[] getErrorList() {
        return errorList;
    }
     ...
     * @param errorList
     */
    public void setErrorList(com.paypal.axis.svcs.types.common.ErrorData[] errorList) {
        this.errorList = errorList;
    }
