...
public class FundingPlan  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.axis.svcs.types.common.CurrencyType fundingAmount;

    private com.paypal.axis.svcs.types.ap.FundingSource backupFundingSource;

    private com.paypal.axis.svcs.types.common.CurrencyType senderFees;

    private com.paypal.axis.svcs.types.ap.CurrencyConversion currencyConversion;

    private com.paypal.axis.svcs.types.ap.FundingPlanCharge[] charge;
    ...
    public FundingPlan(
           ...
           com.paypal.axis.svcs.types.common.CurrencyType fundingAmount,
           com.paypal.axis.svcs.types.ap.FundingSource backupFundingSource,
           com.paypal.axis.svcs.types.common.CurrencyType senderFees,
           com.paypal.axis.svcs.types.ap.CurrencyConversion currencyConversion,
           com.paypal.axis.svcs.types.ap.FundingPlanCharge[] charge,
     ...
     */
    public com.paypal.axis.svcs.types.common.CurrencyType getFundingAmount() {
        return fundingAmount;
    }
     ...
     * @param fundingAmount
     */
    public void setFundingAmount(com.paypal.axis.svcs.types.common.CurrencyType fundingAmount) {
        this.fundingAmount = fundingAmount;
    }
     ...
     */
    public com.paypal.axis.svcs.types.ap.FundingSource getBackupFundingSource() {
        return backupFundingSource;
    }
     ...
     */
    public void setBackupFundingSource(com.paypal.axis.svcs.types.ap.FundingSource backupFundingSource) {
        this.backupFundingSource = backupFundingSource;
    }
     ...
     * @return senderFees
     */
    public com.paypal.axis.svcs.types.common.CurrencyType getSenderFees() {
        return senderFees;
    }
     ...
     * @param senderFees
     */
    public void setSenderFees(com.paypal.axis.svcs.types.common.CurrencyType senderFees) {
        this.senderFees = senderFees;
    }
     ...
     */
    public com.paypal.axis.svcs.types.ap.CurrencyConversion getCurrencyConversion() {
        return currencyConversion;
    }
     ...
     */
    public void setCurrencyConversion(com.paypal.axis.svcs.types.ap.CurrencyConversion currencyConversion) {
        this.currencyConversion = currencyConversion;
    }
     ...
     * @return charge
     */
    public com.paypal.axis.svcs.types.ap.FundingPlanCharge[] getCharge() {
        return charge;
    }
     ...
     * @param charge
     */
    public void setCharge(com.paypal.axis.svcs.types.ap.FundingPlanCharge[] charge) {
        this.charge = charge;
    }

    public com.paypal.axis.svcs.types.ap.FundingPlanCharge getCharge(int i) {
        return this.charge[i];
    }

    public void setCharge(int i, com.paypal.axis.svcs.types.ap.FundingPlanCharge _value) {
