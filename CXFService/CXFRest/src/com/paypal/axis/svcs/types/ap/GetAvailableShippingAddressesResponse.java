...
public class GetAvailableShippingAddressesResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.axis.svcs.types.ap.Address[] availableAddress;
    ...
    public GetAvailableShippingAddressesResponse(
           ...
           com.paypal.axis.svcs.types.ap.Address[] availableAddress,
     ...
     */
    public com.paypal.axis.svcs.types.ap.Address[] getAvailableAddress() {
        return availableAddress;
    }
     ...
     */
    public void setAvailableAddress(com.paypal.axis.svcs.types.ap.Address[] availableAddress) {
        this.availableAddress = availableAddress;
    }

    public com.paypal.axis.svcs.types.ap.Address getAvailableAddress(int i) {
        return this.availableAddress[i];
    }

    public void setAvailableAddress(int i, com.paypal.axis.svcs.types.ap.Address _value) {
