...
public class ResponseEnvelope  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.axis.svcs.types.common.AckCode ack;
    ...
    public ResponseEnvelope(
           ...
           com.paypal.axis.svcs.types.common.AckCode ack,
     ...
     */
    public com.paypal.axis.svcs.types.common.AckCode getAck() {
        return ack;
    }
     ...
     */
    public void setAck(com.paypal.axis.svcs.types.common.AckCode ack) {
        this.ack = ack;
    }
