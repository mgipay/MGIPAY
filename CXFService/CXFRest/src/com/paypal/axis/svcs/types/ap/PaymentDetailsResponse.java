...
public class PaymentDetailsResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.axis.svcs.types.ap.PaymentInfo[] paymentInfoList;
    ...
    public PaymentDetailsResponse(
           ...
           com.paypal.axis.svcs.types.ap.PaymentInfo[] paymentInfoList,
     ...
     */
    public com.paypal.axis.svcs.types.ap.PaymentInfo[] getPaymentInfoList() {
        return paymentInfoList;
    }
     ...
     */
    public void setPaymentInfoList(com.paypal.axis.svcs.types.ap.PaymentInfo[] paymentInfoList) {
        this.paymentInfoList = paymentInfoList;
    }
