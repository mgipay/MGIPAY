...
public class GetShippingAddressesResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.axis.svcs.types.ap.Address selectedAddress;
    ...
    public GetShippingAddressesResponse(
           ...
           com.paypal.axis.svcs.types.ap.Address selectedAddress,
     ...
     */
    public com.paypal.axis.svcs.types.ap.Address getSelectedAddress() {
        return selectedAddress;
    }
     ...
     */
    public void setSelectedAddress(com.paypal.axis.svcs.types.ap.Address selectedAddress) {
        this.selectedAddress = selectedAddress;
    }
