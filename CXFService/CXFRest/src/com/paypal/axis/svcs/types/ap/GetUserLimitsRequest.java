...
public class GetUserLimitsRequest  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.axis.svcs.types.common.AccountIdentifier user;
    ...
    public GetUserLimitsRequest(
           ...
           com.paypal.axis.svcs.types.common.AccountIdentifier user,
     ...
     */
    public com.paypal.axis.svcs.types.common.AccountIdentifier getUser() {
        return user;
    }
     ...
     */
    public void setUser(com.paypal.axis.svcs.types.common.AccountIdentifier user) {
        this.user = user;
    }
