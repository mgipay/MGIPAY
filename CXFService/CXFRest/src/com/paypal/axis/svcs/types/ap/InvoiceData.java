...
public class InvoiceData  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    private com.paypal.axis.svcs.types.ap.InvoiceItem[] item;
    ...
    public InvoiceData(
           com.paypal.axis.svcs.types.ap.InvoiceItem[] item,
     ...
     * @return item
     */
    public com.paypal.axis.svcs.types.ap.InvoiceItem[] getItem() {
        return item;
    }
     ...
     * @param item
     */
    public void setItem(com.paypal.axis.svcs.types.ap.InvoiceItem[] item) {
        this.item = item;
    }

    public com.paypal.axis.svcs.types.ap.InvoiceItem getItem(int i) {
        return this.item[i];
    }

    public void setItem(int i, com.paypal.axis.svcs.types.ap.InvoiceItem _value) {
        this.item[i] = _value;
    }
