...
public class GetAllowedFundingSourcesResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    public com.paypal.axis.svcs.types.ap.FundingSource getFundingSource(int i) {
        return this.fundingSource[i];
    }

    public void setFundingSource(int i, com.paypal.axis.svcs.types.ap.FundingSource _value) {
