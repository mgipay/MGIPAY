...
public class AdaptivePaymentsPortTypeProxy implements com.paypal.axis.svcs.services.AdaptivePaymentsPortType {
  private String _endpoint = null;
  private com.paypal.axis.svcs.services.AdaptivePaymentsPortType adaptivePaymentsPortType = null;
  ...
  private void _initAdaptivePaymentsPortTypeProxy() {
    try {
      adaptivePaymentsPortType = (new com.paypal.axis.svcs.services.AdaptivePaymentsLocator()).getAdaptivePaymentsSOAP11_http();
  ...
  public com.paypal.axis.svcs.services.AdaptivePaymentsPortType getAdaptivePaymentsPortType() {
    if (adaptivePaymentsPortType == null)
      _initAdaptivePaymentsPortTypeProxy();
