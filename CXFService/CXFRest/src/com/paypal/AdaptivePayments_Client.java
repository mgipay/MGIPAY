...
import com.paypal.svcs.services.AdaptivePaymentsLocator;
import com.paypal.svcs.services.AdaptivePaymentsPortType;
import com.paypal.svcs.services.AdaptivePaymentsSOAP11BindingStub;
...
public class AdaptivePayments_Client extends TestCase {
	 ...
	 * @throws Exception
	 */
	public static GetUserLimitsResponse getUserLimits(String emailID)
			throws Exception {
		...
		PhoneNumberType phoneNumberType = new PhoneNumberType("1",
				"6057100363", "4237");
		AccountIdentifier user = new AccountIdentifier(emailID,
