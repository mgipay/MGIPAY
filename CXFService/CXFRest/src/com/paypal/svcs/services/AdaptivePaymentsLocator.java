...
public class AdaptivePaymentsLocator extends org.apache.axis.client.Service implements com.paypal.svcs.services.AdaptivePayments {
    ...
    public com.paypal.svcs.services.AdaptivePaymentsPortType getAdaptivePaymentsSOAP11_http() throws javax.xml.rpc.ServiceException {
    ...
    public com.paypal.svcs.services.AdaptivePaymentsPortType getAdaptivePaymentsSOAP11_http(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.paypal.svcs.services.AdaptivePaymentsSOAP11BindingStub _stub = new com.paypal.svcs.services.AdaptivePaymentsSOAP11BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.paypal.svcs.services.AdaptivePaymentsPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.paypal.svcs.services.AdaptivePaymentsSOAP11BindingStub _stub = new com.paypal.svcs.services.AdaptivePaymentsSOAP11BindingStub(new java.net.URL(AdaptivePaymentsSOAP11_http_address), this);
                _stub.setPortName(getAdaptivePaymentsSOAP11_httpWSDDServiceName());
                return _stub;
            }
        }
