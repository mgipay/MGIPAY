...
public class CurrencyConversionList  implements java.io.Serializable {
    private com.paypal.svcs.types.common.CurrencyType baseAmount;

    private com.paypal.svcs.types.common.CurrencyType[] currencyList;

    public CurrencyConversionList() {
    }

    public CurrencyConversionList(
           com.paypal.svcs.types.common.CurrencyType baseAmount,
           com.paypal.svcs.types.common.CurrencyType[] currencyList) {
     ...
     * @return baseAmount
     */
    public com.paypal.svcs.types.common.CurrencyType getBaseAmount() {
        return baseAmount;
    }
     ...
     * @param baseAmount
     */
    public void setBaseAmount(com.paypal.svcs.types.common.CurrencyType baseAmount) {
        this.baseAmount = baseAmount;
    }
     ...
     * @return currencyList
     */
    public com.paypal.svcs.types.common.CurrencyType[] getCurrencyList() {
        return currencyList;
    }
     ...
     * @param currencyList
     */
    public void setCurrencyList(com.paypal.svcs.types.common.CurrencyType[] currencyList) {
        this.currencyList = currencyList;
    }
