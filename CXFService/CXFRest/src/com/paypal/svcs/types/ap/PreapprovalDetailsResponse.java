...
public class PreapprovalDetailsResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.svcs.types.ap.Address[] addressList;
    ...
    public PreapprovalDetailsResponse(
           ...
           com.paypal.svcs.types.ap.Address[] addressList,
     ...
     * @return addressList
     */
    public com.paypal.svcs.types.ap.Address[] getAddressList() {
        return addressList;
    }
     ...
     * @param addressList
     */
    public void setAddressList(com.paypal.svcs.types.ap.Address[] addressList) {
        this.addressList = addressList;
    }
