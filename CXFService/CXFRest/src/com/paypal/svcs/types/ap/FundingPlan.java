...
public class FundingPlan  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.svcs.types.common.CurrencyType fundingAmount;

    private com.paypal.svcs.types.ap.FundingSource backupFundingSource;

    private com.paypal.svcs.types.common.CurrencyType senderFees;

    private com.paypal.svcs.types.ap.CurrencyConversion currencyConversion;

    private com.paypal.svcs.types.ap.FundingPlanCharge[] charge;
    ...
    public FundingPlan(
           ...
           com.paypal.svcs.types.common.CurrencyType fundingAmount,
           com.paypal.svcs.types.ap.FundingSource backupFundingSource,
           com.paypal.svcs.types.common.CurrencyType senderFees,
           com.paypal.svcs.types.ap.CurrencyConversion currencyConversion,
           com.paypal.svcs.types.ap.FundingPlanCharge[] charge,
     ...
     */
    public com.paypal.svcs.types.common.CurrencyType getFundingAmount() {
        return fundingAmount;
    }
     ...
     * @param fundingAmount
     */
    public void setFundingAmount(com.paypal.svcs.types.common.CurrencyType fundingAmount) {
        this.fundingAmount = fundingAmount;
    }
     ...
     */
    public com.paypal.svcs.types.ap.FundingSource getBackupFundingSource() {
        return backupFundingSource;
    }
     ...
     */
    public void setBackupFundingSource(com.paypal.svcs.types.ap.FundingSource backupFundingSource) {
        this.backupFundingSource = backupFundingSource;
    }
     ...
     * @return senderFees
     */
    public com.paypal.svcs.types.common.CurrencyType getSenderFees() {
        return senderFees;
    }
     ...
     * @param senderFees
     */
    public void setSenderFees(com.paypal.svcs.types.common.CurrencyType senderFees) {
        this.senderFees = senderFees;
    }
     ...
     */
    public com.paypal.svcs.types.ap.CurrencyConversion getCurrencyConversion() {
        return currencyConversion;
    }
     ...
     */
    public void setCurrencyConversion(com.paypal.svcs.types.ap.CurrencyConversion currencyConversion) {
        this.currencyConversion = currencyConversion;
    }
     ...
     * @return charge
     */
    public com.paypal.svcs.types.ap.FundingPlanCharge[] getCharge() {
        return charge;
    }
     ...
     * @param charge
     */
    public void setCharge(com.paypal.svcs.types.ap.FundingPlanCharge[] charge) {
        this.charge = charge;
    }

    public com.paypal.svcs.types.ap.FundingPlanCharge getCharge(int i) {
        return this.charge[i];
    }

    public void setCharge(int i, com.paypal.svcs.types.ap.FundingPlanCharge _value) {
