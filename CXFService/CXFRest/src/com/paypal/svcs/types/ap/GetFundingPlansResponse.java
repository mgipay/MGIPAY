...
public class GetFundingPlansResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.svcs.types.ap.FundingPlan[] fundingPlan;
    ...
    public GetFundingPlansResponse(
           ...
           com.paypal.svcs.types.ap.FundingPlan[] fundingPlan,
     ...
     * @return fundingPlan
     */
    public com.paypal.svcs.types.ap.FundingPlan[] getFundingPlan() {
        return fundingPlan;
    }
     ...
     * @param fundingPlan
     */
    public void setFundingPlan(com.paypal.svcs.types.ap.FundingPlan[] fundingPlan) {
        this.fundingPlan = fundingPlan;
    }

    public com.paypal.svcs.types.ap.FundingPlan getFundingPlan(int i) {
        return this.fundingPlan[i];
    }

    public void setFundingPlan(int i, com.paypal.svcs.types.ap.FundingPlan _value) {
