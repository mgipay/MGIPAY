...
public class GetUserLimitsResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private com.paypal.svcs.types.ap.UserLimit[] userLimit;

    private com.paypal.svcs.types.ap.WarningData[] warningDataList;
    ...
    public GetUserLimitsResponse(
           ...
           com.paypal.svcs.types.ap.UserLimit[] userLimit,
           com.paypal.svcs.types.ap.WarningData[] warningDataList,
     ...
     * @return userLimit
     */
    public com.paypal.svcs.types.ap.UserLimit[] getUserLimit() {
        return userLimit;
    }
     ...
     * @param userLimit
     */
    public void setUserLimit(com.paypal.svcs.types.ap.UserLimit[] userLimit) {
        this.userLimit = userLimit;
    }

    public com.paypal.svcs.types.ap.UserLimit getUserLimit(int i) {
        return this.userLimit[i];
    }

    public void setUserLimit(int i, com.paypal.svcs.types.ap.UserLimit _value) {
     ...
     */
    public com.paypal.svcs.types.ap.WarningData[] getWarningDataList() {
        return warningDataList;
    }
     ...
     */
    public void setWarningDataList(com.paypal.svcs.types.ap.WarningData[] warningDataList) {
        this.warningDataList = warningDataList;
    }
