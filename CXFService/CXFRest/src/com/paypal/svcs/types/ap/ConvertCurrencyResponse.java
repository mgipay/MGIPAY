...
public class ConvertCurrencyResponse  implements java.io.Serializable {
    ...
    private com.paypal.svcs.types.ap.CurrencyConversionList[] estimatedAmountTable;
    ...
    public ConvertCurrencyResponse(
           ...
           com.paypal.svcs.types.ap.CurrencyConversionList[] estimatedAmountTable) {
     ...
     */
    public com.paypal.svcs.types.ap.CurrencyConversionList[] getEstimatedAmountTable() {
        return estimatedAmountTable;
    }
     ...
     */
    public void setEstimatedAmountTable(com.paypal.svcs.types.ap.CurrencyConversionList[] estimatedAmountTable) {
        this.estimatedAmountTable = estimatedAmountTable;
    }
