...
public class FundingConstraint  implements java.io.Serializable {
    private com.paypal.svcs.types.ap.FundingTypeInfo[] allowedFundingType;

    public FundingConstraint() {
    }

    public FundingConstraint(
           com.paypal.svcs.types.ap.FundingTypeInfo[] allowedFundingType) {
     ...
     */
    public com.paypal.svcs.types.ap.FundingTypeInfo[] getAllowedFundingType() {
        return allowedFundingType;
    }
     ...
     */
    public void setAllowedFundingType(com.paypal.svcs.types.ap.FundingTypeInfo[] allowedFundingType) {
        this.allowedFundingType = allowedFundingType;
    }
