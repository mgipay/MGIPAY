...
public class DayOfWeek implements java.io.Serializable {
    ...
    public static final java.lang.String _NO_DAY_SPECIFIED = "NO_DAY_SPECIFIED";
    ...
    public static final DayOfWeek NO_DAY_SPECIFIED = new DayOfWeek(_NO_DAY_SPECIFIED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://svcs.paypal.com/types/common", "DayOfWeek"));
    }
    /**
