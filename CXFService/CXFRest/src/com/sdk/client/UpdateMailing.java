...
@XmlRootElement(name = "updateMailing", namespace = "uri:mailing.ws.sdk.edialog.com")
public class UpdateMailing {
    ...
    @XmlElement(namespace = "uri:mailing.ws.sdk.edialog.com", nillable = true)
