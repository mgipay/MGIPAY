 ...
 * 				about a mailing.
 * 
 * <p>Java class for MailingViewWithUdfType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MailingViewWithUdfType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="cell" type="{uri:ereport.ws.sdk.edialog.com}eReportsCellOverviewWithUdfType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "MailingViewWithUdfType", namespace = "uri:ereport.ws.sdk.edialog.com", propOrder = {
    "mailingId",
    "mailingName",
    "cell",
    "dateMailed",
...
public class MailingViewWithUdfType {

    protected int mailingId;
    @XmlElement(required = true, nillable = true)
    protected String mailingName;
    protected List<EReportsCellOverviewWithUdfType> cell;
    @XmlElement(required = true, nillable = true)
     ...
     * {@link EReportsCellOverviewWithUdfType }
     * 
     * 
     */
    public List<EReportsCellOverviewWithUdfType> getCell() {
        if (cell == null) {
            cell = new ArrayList<EReportsCellOverviewWithUdfType>();
        }
        return this.cell;
    }
