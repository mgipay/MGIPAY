 ...
 *         &lt;element name="row" type="{uri:grid.ws.sdk.edialog.com}GridRowType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "updateGrid", namespace = "uri:grid.ws.sdk.edialog.com")
public class UpdateGrid {
    ...
    @XmlElement(namespace = "uri:grid.ws.sdk.edialog.com")
    protected List<GridRowType> row;
     ...
     * 
     */
    public List<GridRowType> getRow() {
        if (row == null) {
            row = new ArrayList<GridRowType>();
        }
        return this.row;
    }
