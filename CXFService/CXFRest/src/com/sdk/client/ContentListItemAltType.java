 ...
 * 
 * <p>Java class for contentListItemAltType complex type.
 * 
 ...
 *         &lt;element name="content" type="{uri:content.ws.sdk.edialog.com}contentItemAltType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "contentListItemAltType", namespace = "uri:content.ws.sdk.edialog.com", propOrder = {
    "currentPageNumber",
    "totalNumberOfRows",
    "totalNumberOfPages",
    "content"
})
public class ContentListItemAltType {

    protected int currentPageNumber;
    protected int totalNumberOfRows;
    protected int totalNumberOfPages;
    protected List<ContentItemAltType> content;
     ...
     * {@link ContentItemAltType }
     * 
     * 
     */
    public List<ContentItemAltType> getContent() {
        if (content == null) {
            content = new ArrayList<ContentItemAltType>();
        }
        return this.content;
    }
