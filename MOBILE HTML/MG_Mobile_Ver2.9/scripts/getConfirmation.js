...
function sendSMS()
{
	var conf = confirm("Text your Reference Number?  Text to: "+phoneNumber+". You may incur a charge from your mobile service provider for the text.");
    if(conf == true){
...
function sendMail()
{
		...
		sendObj.token = loginResponse.token;
