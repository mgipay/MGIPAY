...
var emailSuccessHandler = function(response) {
	...
	if(response.transactionSuccess == true)
	{
		...
		if($("#reasonID option:selected").html() == "Refund")
		{
			$("#mailSent").addClass("displayblock").removeClass("displaynone");
			$("#sentDetails").addClass("displaynone").removeClass("displayblock");;
		}
		else
		{
			$("#mailSent").addClass("displayblock").removeClass("displaynone");
			$("#sentDetails").addClass("displayblock").removeClass("displaynone");;
			$("#refNumber").html(response.messageToUser);
		}
	}
	else
	{
