...
function openHistoryDetails(index)
{
	...
	historyDetails.push(details.transactionDate,details.customerName,resources.country,"New Jersey",details.transactionAmount,details.transactionFee,totalamount,details.mgiReferenceNumber);
	if($.browser.chrome) {
