...
$(document).ready(function() {
				...
				$('.paypal_login').click(function () {
					...
					window.location.href = "https://www.stage2cp07.stage.paypal.com:8443/webapps/auth/protocol/openidconnect/v1/authorize?client_id="+constantVariables.clientID+"&response_type=code&scope=profile email address phone https://uri.paypal.com/services/AdaptivePaymentsPayAPI openid&redirect_uri=https://"+constantVariables.urlPath+"/mobile/blank.html";
